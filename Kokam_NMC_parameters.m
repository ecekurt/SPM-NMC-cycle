...
% p.Ds_n0 =1e-11;    % Diffusion coeff for solid in neg. electrode, [m^2/s] 
...
p.h= 0; % 5-10 for free convection air cooling %10-70 for forced air cooling
...
p.Rsei_n = 2037.4;      % [Ohms*m] Resistivity of SEI layer, Howey
p.Rsei_p=0;
p.Rdc=0.0102;       % DC resistance of the total cell in Ohm
p.Rcell = p.Rdc * ((p.L_p * p.a_n * p.Area_p + p.L_n * p.a_n * p.Area_n) / 2); % specific resistance of the combined electrodes
